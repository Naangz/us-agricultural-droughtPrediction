...
# %% [code cell 2]
SEED = 42
DATA_PATH = 'Integrated_weekly_KAN_20counties.csv'
OUTPUT_FOLDER = 'output_weekly_kansas_scenario3'
...
with open(summary_path, 'w', encoding='utf-8') as f:
    f.write('BiLSTM Weekly Kansas - Scenario 3: Macro F1-driven Feature Selection\n')
