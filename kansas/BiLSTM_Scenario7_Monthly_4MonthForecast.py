...
OUTPUT_FOLDER = os.path.join(KANSAS_DIR, "output_monthly_kansas_scenario7_avg_horizon4")
...
def main():
    ...
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("BiLSTM Monthly Kansas Scenario 7 - 4-Month Forecast\n")
...
"""
    ...
    readme_content = """---
title: Kansas Monthly Drought Prediction Scenario 7
...
(None, D0-D4) for 20 Kansas counties using monthly drought history inputs and a
