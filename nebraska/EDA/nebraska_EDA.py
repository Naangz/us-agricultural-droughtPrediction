...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help='Path to Integrated_weekly_NEB_20counties.csv (defaults to repo root).',
    )
    parser.add_argument(
        '--output-dir',
        type=Path,
...
def main(data_path=None, output_dir=None):
    ...
    eda_fig_path = output_dir / 'nebraska_eda.png'
    weekly_fig_path = output_dir / 'nebraska_weekly_majority_share.png'
    ...
    fig.suptitle('Nebraska Weekly EDA', fontsize=18, fontweight='bold')
    ...
    ax.set_title('Nebraska Weekly Majority Share with Minority-Dominant Periods Highlighted')
