...
# Scenario 2C: Correlation-aware statistical feature selection (Top-30)
...
OUTPUT_FOLDER = os.path.join(NEBRASKA_DIR, 'output_weekly_nebraska_scenario2C')
...
print(f'Scenario 2C: Correlation threshold = {CORRELATION_THRESHOLD}, Target feature count = {TARGET_FEATURE_COUNT}')
...
print('\n' + '=' * 80)
print('SCENARIO 2C: Feature Selection (Correlation-aware Mutual Information, Top-30)')
print('=' * 80)
...
with open(summary_path, 'w', encoding='utf-8') as f:
    f.write('BiLSTM Weekly Nebraska - Scenario 2C: Correlation-aware Feature Selection (Top-30)\n')
