...
# Scenario 2: Correlation-aware statistical feature selection
...
OUTPUT_FOLDER = os.path.join(NEBRASKA_DIR, 'output_weekly_nebraska_scenario2')
...
print(f'Scenario 2: Correlation threshold = {CORRELATION_THRESHOLD}, Target feature count = {TARGET_FEATURE_COUNT}')
...
print('\n' + '=' * 80)
print('SCENARIO 2: Feature Selection (Correlation-aware Mutual Information)')
print('=' * 80)
...
with open(summary_path, 'w', encoding='utf-8') as f:
    f.write('BiLSTM Weekly Nebraska - Scenario 2: Correlation-aware Feature Selection\n')
