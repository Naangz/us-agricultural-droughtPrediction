...
# Scenario 2B: Correlation-aware statistical feature selection (Top-25)
...
OUTPUT_FOLDER = os.path.join(NEBRASKA_DIR, 'output_weekly_nebraska_scenario2B')
...
print(f'Scenario 2B: Correlation threshold = {CORRELATION_THRESHOLD}, Target feature count = {TARGET_FEATURE_COUNT}')
...
print('\n' + '=' * 80)
print('SCENARIO 2B: Feature Selection (Correlation-aware Mutual Information, Top-25)')
print('=' * 80)
...
with open(summary_path, 'w', encoding='utf-8') as f:
    f.write('BiLSTM Weekly Nebraska - Scenario 2B: Correlation-aware Feature Selection (Top-25)\n')
