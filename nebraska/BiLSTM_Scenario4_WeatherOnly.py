...
OUTPUT_FOLDER = os.path.join(NEBRASKA_DIR, 'output_weekly_nebraska_scenario4')

SCENARIO_NAME = 'Scenario 4 - Weather Only'
...
with open(summary_path, 'w', encoding='utf-8') as f:
    f.write('BiLSTM Weekly Nebraska - Scenario 4: Weather Only\n')
