...
OUTPUT_FOLDER = os.path.join(NEBRASKA_DIR, 'output_weekly_nebraska_scenario5')

SCENARIO_NAME = 'Scenario 5 - Weather + Lag Only'
...
with open(summary_path, 'w', encoding='utf-8') as f:
    f.write('BiLSTM Weekly Nebraska - Scenario 5: Weather + Lag Only\n')
