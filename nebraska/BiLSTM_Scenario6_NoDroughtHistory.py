...
OUTPUT_FOLDER = os.path.join(NEBRASKA_DIR, 'output_weekly_nebraska_scenario6')

SCENARIO_NAME = 'Scenario 6 - No Drought History'
...
with open(summary_path, 'w', encoding='utf-8') as f:
    f.write('BiLSTM Weekly Nebraska - Scenario 6: No Drought History\n')
